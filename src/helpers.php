...
/**
 * Captures and returns the output generated by a callback function.
 *
 * @param callable $callback A callback function whose output is to be captured.
 * @return string The output generated by the callback function.
 */
